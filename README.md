...
```
#### 项目总结
**We重邮** 是一款中型成熟微信小程序，校园生活助手与管家，是我第一个小程序线上项目，由我负责前端小程序界面。在此更名为‘we湖科’。
##### 关于we重邮
> **We重邮** 是一款**微信小程序**，由蓝山工作室（学生技术组织/团队）开发，有别于公众号的一种全新的连接用户与服务的方式，无需下载与安装即可在微信内被便捷地获取和传播，同时具有出色的使用体验。
> 
